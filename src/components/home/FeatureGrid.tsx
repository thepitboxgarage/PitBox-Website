const FEATURES = [
  ...
  },
  {
    ...
    title: 'Interactive Manual System',
    description:
      'Each bay features a 55" flatscreen with our proprietary automotive repair catalog — step-by-step guides for thousands of service procedures, searchable by make, model, and job type.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
