  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(105deg, rgba(10,10,10,0.96) 0%, rgba(10,10,10,0.85) 45%, rgba(10,10,10,0.50) 100%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 lg:pt-32 lg:pb-20 w-full">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          >
            ...
            Premium Tools.
            <br />
            <span className="text-pitbox-amber">Your Project.</span>
          </h1>
          ...
          {/* Sub */}
          <p className="text-md text-[#d4d4d4] leading-relaxed mb-10 max-w-lg">
            Built for enthusiasts, racers, and technicians who need more than a
            driveway. Rent a fully equipped bay by the hour, half-day, or full
            day — professional tools, a hoist, and ALLDATA repair data included.
            No compromises.
          </p>
          ...
          <p className="mt-10 text-sm text-[#737373]">
            ...
            <span className="mx-3 text-[#383838]">·</span>6 bays available
