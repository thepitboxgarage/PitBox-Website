      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="text-sm font-semibold text-pitbox-text uppercase tracking-widest mb-4">
                Contact Info
              </h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.label} className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-pitbox-subtle mb-0.5">
                        {item.label}
                      </p>
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-sm text-pitbox-muted hover:text-pitbox-amber transition-colors"
                        >
                          {item.value}
                        </a>
                      ) : (
                        <p className="text-sm text-pitbox-muted">
                          {item.value}
                        </p>
                      )}
                    </div>
          ...
          <div>
            {submitted ? (
              <div className="flex flex-col items-center justify-center text-center h-full min-h-48 gap-4">
                ...
                <h3 className="text-lg font-semibold text-pitbox-text">
                  Message sent
                </h3>
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-pitbox-text">
                    I'm inquiring about
                  </label>
                  <select
                    ...
                    defaultValue=""
                  >
                    <option value="" disabled className="text-pitbox-subtle">
                      Select inquiry type…
                    </option>
                    {INQUIRY_TYPES.map((t) => (
